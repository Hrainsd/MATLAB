% 灰狼优化算法
function [best_solution, best_fitness] = Grey_Wolf_Max_Fun(obj_func, dim, lb, ub, max_iter, pack_size)
    ...
    for iter = 1:max_iter
        ...
        % 输出当前迭代的最佳适应值
%         disp(['Iteration ', num2str(iter), ': Best Fitness (Max Value) = ', num2str(alpha_score)]);
    end
